  ...
  class MenuCard {
    ...
    render() {
      ...
      if (this.classes.length === 0) {
        this.element = 'menu__item', element.classList.add(this.element);
      } else {
...
function openModal(modalSelector, modalTimerId) {
  ...
  modal.classList.toggle('show'), document.body.style.overflow = 'hidden';
...
function closeModal(modalSelector) {
  const modal = document.querySelector(modalSelector);
  modal.classList.toggle('show'), document.body.style.overflow = '';
}
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2022-08-05');
